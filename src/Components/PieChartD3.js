...
function PieChartD3(){
    ...
    useEffect(() =>{
        ...
        const fetchData = async() => {
            try{
            await axios.get(baseURL+'/budget').then((response) => {
               // for(var i = 0; i < response.data.myBudget.length; i++){
               //     dataSource.datasets[0].data[i] = response.data.myBudget[i].budget;
               //     dataSource.labels[i] = response.data.myBudget[i].title;
               // }
               ...
               var nums = [1,2,3];
               var titles = ["hi","hello","no"];
               for(var i = 0; i < response.data.myBudget.length; i++){
                    console.log(response.data.myBudget[i].budget);
                    nums[i] = response.data.myBudget[i].budget;
                    titles[i] = response.data.myBudget[i].title;
                }

                var svgElem = document.getElementById("myChart2");
...
//         var nums = [1,2,3];
//         var titles = ["hi","hello","no"];
//         // for(var i = 0; i < d3Data; i++){
//         //     nums[i] = d3Data[i].budget;
//         //     titles[i] = d3Data[i].title;
//         //     }
